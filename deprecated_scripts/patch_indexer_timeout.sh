...
# ==================================================================================
# Patch Script for the Resource Indexer
# This makes the indexer more resilient to network timeouts and errors.
# ==================================================================================

echo "--- Patching the Resource Indexer for Network Resilience ---"
...
const indexData = async () => {
    ...
    try {
        ...
        const dataGovUrl = 'https://data.nasa.gov/api/catalog/v1?limit=1000';
        // NEW: Added a long timeout of 120 seconds (120000 ms)
        const dataGovResponse = await axios.get(dataGovUrl, { timeout: 120000 });
    ...
    try {
        ...
        // NEW: Added a timeout here as well for robustness.
...
echo ""
echo "✅ Indexer has been patched with longer timeouts and better error handling."
echo ""
echo "INSTRUCTIONS:"
echo "1. Navigate to the 'server' directory: cd server"
echo "2. Run the indexer again. It is now much more likely to succeed."
